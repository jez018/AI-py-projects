# -*- coding: utf-8 -*-
"""
Created on Mon May 17 06:02:26 2021
...
last_5_candle = luno_ng.of_15m[:1000]

from pandas import DataFrame
#this is a dataframe created from luno candle data
luno_btc_df = DataFrame(last_5_candle, columns=["open_timestamp", "open", "high", "low", "close", "volume_base", "volume_quote"])
